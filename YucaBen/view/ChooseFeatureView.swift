                    ...
                    VStack(alignment: .leading) {
                        ...
                        Group {
                            Text("Kutu Bilgileri")
                                ...
                                .accentColor(.black)
                            Spacer()
                            Text("Karton Gramaj(gram):  " + String(viewModel.weight))
                                .font(.system(size: 15))
                                .font(.callout)
                                .accentColor(.black)
                            ...
                            Text("Kutu Adedi(tane):  " + String(viewModel.piece))
                                ...
                                .font(.callout)
                                .accentColor(.black)
                            Text("Ürün/Plaka:  " + String(viewModel.productSheet))
                                .font(.system(size: 15))
                                .font(.callout)
                                .accentColor(.black)
                            Text("Baskı Ücreti:  " + String(viewModel.printAmount))
                                .font(.system(size: 15))
                                .font(.callout)
                                .accentColor(.black)
                        ...
                        Group {
                            CheckboxFieldView(checkState:false,title:"Krome",perAmount: "8", functionalityType: Functionality.allPurposeFunctionality).environmentObject(summaryModel).environmentObject(viewModel)
                            ...
                            CheckboxFieldView(checkState:false,title:"Safiha", perAmount: "3,63", functionalityType: Functionality.meterFunctionality).environmentObject(summaryModel).environmentObject(viewModel)
